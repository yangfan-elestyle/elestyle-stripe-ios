Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/Stripe.xcframework.zip", :sha256 => "e12813e338eaea100a68642b62b04d25f3c5c39fd925b6a95f58c3fa0ad386fd" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'Stripe.xcframework'
