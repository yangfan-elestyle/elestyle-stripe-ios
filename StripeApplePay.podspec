Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/StripeApplePay.xcframework.zip", :sha256 => "9786ed5b39a42fbd5123ba19aebc983729269555a555552d996896967e16905a" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'StripeApplePay.xcframework'
