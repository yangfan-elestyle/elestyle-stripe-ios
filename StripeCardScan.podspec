Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/StripeCardScan.xcframework.zip", :sha256 => "624dd8970ad451452a85f8e341a289dddedb9b9a58ed1569209a59d8ab78a544" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'StripeCardScan.xcframework'
