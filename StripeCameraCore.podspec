Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/StripeCameraCore.xcframework.zip", :sha256 => "c96b55cf499d308268c57f717bf4801f8b43d381ecedee8d878de9f3399d6af7" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'StripeCameraCore.xcframework'
