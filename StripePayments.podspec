Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/StripePayments.xcframework.zip", :sha256 => "72ce13b7ab4c13d797caa6a3ad3464221907b7b80d64843bccc928a35ccca729" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'StripePayments.xcframework'
