Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elestyle-stripe-ios/releases/download/24.13.2/StripeIdentity.xcframework.zip", :sha256 => "9f50bc6c794a6a678d2ec4dabf1620f07f23c24280533c6fb942fc2b8470564a" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.vendored_frameworks = 'StripeIdentity.xcframework'
